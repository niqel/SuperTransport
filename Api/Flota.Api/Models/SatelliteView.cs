...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class SatelliteView : IEquatable<SatelliteView>
    { 
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((SatelliteView)obj);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(SatelliteView other)
        {
            ...
            return 
                (
                    ...
                    Offices != null &&
                    Offices.SequenceEqual(other.Offices)
                ) && 
                (
                    Trucks == other.Trucks ||
                    Trucks != null &&
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    if (Offices != null)
                    hashCode = hashCode * 59 + Offices.GetHashCode();
                    if (Trucks != null)
        ...
        public static bool operator ==(SatelliteView left, SatelliteView right)
        {
