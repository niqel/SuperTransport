...
{ 
    ...
    { 
        ...
        /// <summary>
        /// Gets or Sets NonBudgetedExpenseId
        /// </summary>

        [DataMember(Name="non_budgeted_expense_id")]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  NonBudgetedExpenseId: ").Append(NonBudgetedExpenseId).Append("\n");
        ...
        public bool Equals(Answer other)
        {
            ...
            return 
                ...
                (
                    NonBudgetedExpenseId == other.NonBudgetedExpenseId ||
                    NonBudgetedExpenseId != null &&
                    NonBudgetedExpenseId.Equals(other.NonBudgetedExpenseId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    if (NonBudgetedExpenseId != null)
                    hashCode = hashCode * 59 + NonBudgetedExpenseId.GetHashCode();
                    if (Answers != null)
